      ...
      <div className=' mx-auto'>
        <div className='flex flex-col sm:flex-row gap-8'>
          <div className='flex flex-col gap-8'>
            <div className='text-left /h-auto mb-auto md:-mb-20 h-40'>
            ...
            <div
              className={`bg-[#1D232C] rounded-lg p-6 space-y-6 h-fit self-start  mt-5 `}
              data-aos="fade-up" data-aos-anchor-placement="center-bottom"
            >
              {/* Company Logo */}
              <div className='relative w-20 h-10 aspect-auto '>
                <Image
                  src={CLIENT_REVIEWS[0].companyLogo}
                  alt={CLIENT_REVIEWS[0].company}
                  fill
              ...
              <div className='flex items-center space-x-3'>
                <div className='relative w-12 h-12 rounded-full overflow-hidden'>
                  <Image
                    src={CLIENT_REVIEWS[0].clientAvatar}
                    alt={CLIENT_REVIEWS[0].clientName}
                    fill
                ...
                <div>
                  <h4 className='text-white font-semibold text-sm'>
                    {CLIENT_REVIEWS[0].clientName}
                  </h4>
                  <p className='text-white text-sm'>
                    {CLIENT_REVIEWS[0].clientRole}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='flex flex-col gap-8'>
            {CLIENT_REVIEWS.slice(1).map(review => (
              <div
                key={review.id}
                className={`bg-[#1D232C] rounded-lg p-6 space-y-6 h-fit self-start  mb-auto `}
                data-aos="fade-up" data-aos-anchor-placement="center-bottom"
              >
                {/* Company Logo */}
                <div className='relative w-20 h-10 aspect-auto '>
