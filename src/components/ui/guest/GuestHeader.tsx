...
const GuestHeader = () => {
  ...
  return (
    <header className='fixed top-0 left-0 right-0 z-50 bg-background border-b border-white/10'>
      <nav className='mx-auto px-5 h-20 flex items-center justify-between md:px-10 lg:px-20 xl:px-36:p-36'>
        {/* Logo */}
      ...
      >
        <div className='container mx-auto px-4 py-8 flex flex-col gap-6'>
          ...
          <div className='flex flex-col gap-4 mt-4'>
            <Button
              variant='link'
              className='w-full justify-center text-white hover:text-primary text-lg'
              asChild
            >
              <Link href='/signup/creator'>Join as Creator</Link>
            </Button>
            <Button
              ...
              asChild
            >
              <Link href='/signup/brand'>Join as Brand</Link>
            </Button>
            <Button
