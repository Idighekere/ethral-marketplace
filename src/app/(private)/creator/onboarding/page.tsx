...
export default function CreatorOnboardingPage() {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 2:
        return <Step2Title onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 3:
        return <Step3Description onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 4:
        return <Step4Gender onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 5:
        return <Step5XDetails onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 6:
        return <Step6ContentType onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 7:
        return <Step7Images onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 8:
        return <Step8Packages onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 9:
        return <Step9Mobile onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 10:
        return <Step10Verification onContinue={goToNextStep} onBack={goToPreviousStep} />
      case 11:
        return <Step11Connect onContinue={goToNextStep} onBack={goToPreviousStep} />
      default:
        return <Step1Location onContinue={goToNextStep} />
    }
  }
