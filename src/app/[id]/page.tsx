...
const InfluencerDetailsPage = ({ params }: PageProps) => {
  const influencer = INFLUENCER_DETAILS
  const isAuthenticated = true // TODO: Replace with your auth logic

  return (
    <div className=' space-y-10 md:space-y-14'>
      <div className='flex flex-col md:flex-row gap-10 items-center justify-between mx-auto py-10'>
        <img
          src={influencer.photos[0]}
          alt={influencer.name}
          className='w-[20rem] h-[20rem] rounded-md object-cover mb-5'
        />
